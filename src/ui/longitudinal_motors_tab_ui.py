...
# 0.00001 mm = 0.01 um (10 nm) is the finest jog/display.  The ZFS13B can
# command finer (≈0.46 nm / microstep) but its repeatability is ~µm, so going
# below ~0.01 um would only show meaningless jitter.
